...
import routerJobs from './routers/jobs.mjs';
...
const initWebUI = () => new Promise((resolve) => {
  ...
  logger.verbose(`${MODULE_NAME} 5DF28078: Initializing`);
  ...
  logger.debug(`${MODULE_NAME} 88BFA0DA: Registering prometheus middleware`);
